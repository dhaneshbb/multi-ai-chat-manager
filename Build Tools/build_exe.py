#!/usr/bin/env python3
"""
Build Script for Multi-AI Chat Manager
Creates a standalone EXE with all dependencies and config files
"""
...
def create_version_info():
    """Create version info file with proper encoding"""
...
config_file = spec_dir / 'config.yml'
...
def ensure_config_exists():
    ...
    if not os.path.exists("config.yml"):
        ...
        default_config = '''# Multi-AI Chat Manager Configuration
app:
  name: "Multi-AI Chat Manager"
  version: "2.0.0"
...
'''
        ...
        print("Default config.yml created - please update AI app shortcut paths")
...
def create_distribution():
    ...
    final_dist = "Multi-AI Chat Manager v2.0"
    ...
    if os.path.exists("config.yml"):
        shutil.copy2("config.yml", final_dist)
    
    # Create readme
    readme_content = """Multi-AI Chat Manager v2.0
...
- Type prompts and press Enter to send to all AI applications
...
For support, check the log file: multi_ai_chat.log
"""
...
def main():
    """Main build process"""
    print("Multi-AI Chat Manager - Build Process")
    print("=" * 40)

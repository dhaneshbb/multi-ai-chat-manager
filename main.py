#!/usr/bin/env python3
"""
Multi-AI Chat Manager - Fixed Main Application
Corrected minimize/maximize functionality
"""
...
def setup_logging():
    ...
    logger.info("Multi-AI Chat Manager v2.0 Fixed Minimize/Maximize started")
...
def load_configuration():
    ...
    print("No config.yml found, creating default configuration")
    return create_default_config()

def create_default_config():
    """Create default configuration with custom app ordering"""
    default_config = {
        'app': {
    ...
    try:
        ...
        print("Default config.yml created with your AI app shortcuts")
    except Exception as e:
...
def main():
    ...
    try:
        print("Multi-AI Chat Manager v2.0 Fixed Minimize/Maximize")
        print("=" * 55)
        ...
        try:
            ...
            from prompt_sender import ReliablePromptSender
            from gui_interface import CleanGUI
        ...
        def send_prompt_callback(prompt):
            """Send prompt to all AI applications"""
            try:
        ...
        def arrange_windows_callback():
            ...
            try:
                # Always refresh first to get current window list
        ...
        # Create GUI callbacks with all functionality
        gui_callbacks = {
        ...
        def init_ai_apps():
            try:
                ...
                if window_count > 0:
                    gui.update_status(f"Ready! {window_count} AI apps in grid, minimize/maximize fixed", "success")
                    print(f"{window_count} AI applications ready with working minimize/maximize")
                else:
        ...
        print("Starting Multi-AI Chat Manager with Fixed Minimize/Maximize")

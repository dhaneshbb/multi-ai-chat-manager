...
(function() {
    ...
    console.log(`Universal AI Auto-Focus loaded for: ${platformName}`);
    ...
    function findInput() {
        // Universal selectors for different AI platforms
        const selectors = [
            // ChatGPT
            '#prompt-textarea',
    ...
    setTimeout(() => {
        console.log(`${platformName} - Available textareas:`, document.querySelectorAll('textarea'));
        console.log(`${platformName} - Available contenteditable:`, document.querySelectorAll('[contenteditable="true"]'));
